...
const AD_UNIT_IDS = {
  interstitial: __DEV__
    ...
    : 'ca-app-pub-XXXXXXXXXXXXXXXX/YYYYYYYYYY', // Replace with your production interstitial ID
  rewarded: __DEV__
    ? TestIds.REWARDED // Test ID for development
    : 'ca-app-pub-XXXXXXXXXXXXXXXX/YYYYYYYYYY', // Replace with your production rewarded ID
};
